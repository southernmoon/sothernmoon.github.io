...
let popup1 = document.querySelector('.popup1'); //кол-во попапов
...
let openPopupButtons1 = document.querySelectorAll('.open-popup1'); //кол-во попапов
...
if (document.documentElement.clientWidth > 1023) {
	...
	openPopupButtons5.forEach(function(button)  { 
		button.addEventListener('mouseenter', (e) => { 
				e.preventDefault(); 
	...
	openPopupButtons6.forEach(function(button)  { 
		button.addEventListener('mouseenter', (e) => { 
				e.preventDefault(); 
